...
public class Course {
    ...
    // L'assistant d'enseignement pour ce cours, ÉCRIT PAR AVERY NG
    ...
    //Méthodes concernant l'ajout d'un TA: ÉCRIT PAR AVERY NG
    ...
    private String getTeachingAssistantName() {
        if (TeachingAssistant != null) {
            return (TeachingAssistant.getFirstName() + " " + TeachingAssistant.getLastName());
        }
        else {
    ...
    public String toString() {
        return "Course information:\n"
                ...
                + "\tCourse assistants: " + getTeachingAssistantName() + "\n" //ÉCRIT PAR AVERY NG
